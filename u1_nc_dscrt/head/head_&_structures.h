...
#define STEP (1.0)          // STEP DI DISCRETIZZAZIONE PER I CAMPI
...
typedef struct {  // DEFINISCO IL TIPO SystemParam_t STRUTTURATO NEL SEGUENTE MODO
  ...
  int iStart;     // INDICE PER PARTENZA ORDINATA (0) O DA FILE (1)
  int iBackup;    // INDICE PER SALVARE OGNI iBackup MISURE LA CONFIG
...
void writeLogs(SystemParam_t *Par);                                   // PROCEDURA CHE SALVA IL FILE DI LOG
